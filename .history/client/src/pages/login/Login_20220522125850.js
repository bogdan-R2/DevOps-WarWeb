  ...
  <LandingNav/>
    ...
    <fieldset>
      ...
      <div className="form-group row">
        <label htmlFor="staticEmail" className="col-sm-2 col-form-label">Template:</label>
        <div className="col-sm-10">
          <input type="text" readOnly className="form-control-plaintext ml-2" id="staticEmail" defaultValue="email@example.com" />
