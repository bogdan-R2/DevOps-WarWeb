 ...
 <div className="wrapper">
    <div className="card">
      <div className="card__body">
          ...
          <h3 className="card__title">Current capacity: {props.userRequest.currentCapacity}</h3>
          <h3 className="card__title">Maximum capacity: {props.userRequest.maxCapacity}</h3>
          <h3 className="card__title">Country: {props.userRequest.country}</h3>
          ...
          <p className="card__description">Description: {props.userRequest.address}</p>
          <p className="card__description">Description: {props.userRequest.description}</p>
       </div>
    </div>
  </div>
</div>
