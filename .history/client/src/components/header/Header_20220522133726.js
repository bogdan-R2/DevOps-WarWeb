...
import { NavBtnLink } from "../landing-page-nav/NavbarElements";
...
<>
 {/*{ userEmail.value && (*/}
 {userData && (
  <Navbar className="nav-bar-main" bg="dark" variant="dark" style={customStyles}>
     ...
     <NavBtn bg="dark" variant="dark" type="button" className="btn btn-primary ml-2 mr-2 ">
          See all requests
     </Button>
     </Link>
