...
<div className="card text-white bg-primary mb-3" >
    <div className="card">
      <div className="card_body">
          <h2 className="card_title">Type: {props.userRequest.requestType}</h2>
          <h3 className="card_title">Category: {props.userRequest.category}</h3>
          <p className="card__text">City: {props.userRequest.city}</p>
          <p className="card_text">Phone number: {props.userRequest.phoneNumber}</p>
          <p className="card_description">Description of service: {props.userRequest.description}</p>
